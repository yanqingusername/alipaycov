const _my = require("../__antmove/api/index.js")(my); // 查看手机号是否正确
...
function upload_file(controller, file, name, data, cb) {
  var url = apiurl + controller; // 对data中的数据进行encodeURI处理
...
function checkAuditTime(beginTime) {
...
function checkAuditTime_before30min(beginTime) {
  //09:00-12:00 || 09:00-12:00;13:00-18:00
  if (beginTime == "" || beginTime == undefined || beginTime == null) {
    return true;
  } else {
