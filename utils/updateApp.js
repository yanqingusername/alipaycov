...
function updateApp(appName) {
  ...
  if (_my.canIUse("getUpdateManager")) {
    const updateManager = _my.getUpdateManager();
          ...
          success: function (res) {
            ...
            if (res.confirm) {
              ...
              updateManager.onUpdateReady(function () {
                console.log("新的版本已经下载好，调用 applyUpdate 应用新版本并重启"); // 新的版本已经下载好，调用 applyUpdate 应用新版本并重启
