  ...
  getChannelList: function() {
    ...
    _my.getLocation({
      ...
      success(res) {
        ...
        _my.setStorageSync('longitude', res.longitude)
        _my.setStorageSync('latitude', res.latitude)
        ...
        request.request_get("/newalipay/getAllFixedSamplingPoint1.hn", data, function(res) {
          ...
          if (res) {
            if (res.success) {
              ...
              if(that.data.searchText || that.data.lableid || that.data.isbigscreen || that.data.yingye){
